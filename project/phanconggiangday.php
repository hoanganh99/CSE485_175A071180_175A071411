               ...
               <div class="melu">
                  ...
                  <table class="list-course" bgcolor="#FFFFFF" border="1">
                     <tr class="title">
                        ...
                        <td width="100">Mã giáo viên</td>
                        <td width="200">Tên giáo viên</td>
                        <td width="150">Mã lớp</td>
                        <td width="150">Môn học</td>                                  
                     </tr>
                     <tr>
                        <td><input type="checkbox"></td>
                        <td><a href="suaphanconggiangday.php"><i class="fa fa-edit"></i></a></td>
                        <td><a href=""><i class="fa fa-trash-alt"></i></a></td>
                        <td ><a href="suagv.html">Phan Thanh Bình</a></td>
                        <td><a href="sualophoc.html">E032</a></td>
                        <td><a href="suamonhoc.html">English</a></td>                                  
                     </tr>
                     <tr>
                        <td><input type="checkbox"></td>
                        <td><a href="suaphanconggiangday.php"><i class="fa fa-edit"></i></a></td>
